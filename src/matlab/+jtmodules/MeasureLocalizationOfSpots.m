classdef  MeasureLocalizationOfSpots < handle
...
function [matLocMeasurementsZScored, figure] =  main(SegmentedParentObjectImage, ...
        SegmentedThirdObjectImage, DilationFactor, ...
        matPerVector, matRadiousVector, ThirdStatus, matChildrenLocation, ...
        matParentObject, matParentLocation, matThirdLocation, plot)
