...
function [imFinalObjects, figure] =  main(ThresholdCorrection, ...
    ThresholdRange, CuttingPasses, SolidityThres, FormFactorThres, ...
    UpperSizeThres, LowerSizeThres, LowerSizeCutThres, TestMode2, WindowSize, ...
    smoothingDiskSize, PerimSegEqRadius, PerimSegEqSegment, TestMode, input_image)
...
if ~isempty(imInputObjects)
    ...
    if ~isempty(imCut)
        ...
        imDilatedMask = IdentifySecPropagateSubfunction(double(imErodeMask),input_image,imCut,1);
    end
