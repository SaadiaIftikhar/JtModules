...
function [cellPerimeterProps, imFinalObjects, imObjects, ...
    ...
    objSolidity, objArea] = main(input_image, ThresholdCorrection, ...
...
if GetThreshold
    ...
    [OrigThreshold] = CPthreshold(Threshold,pObject,MinimumThreshold,MaximumThreshold,ThresholdCorrection,OrigImage,ImageName,ModuleName,ObjectName);
else
    OrigThreshold = 0;
end
